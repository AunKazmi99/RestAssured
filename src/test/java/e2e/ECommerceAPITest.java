...
public class ECommerceAPITest {
    ...
    public static void main(String[] args) {
        ...
        loginRequest.setUserEmail("aun@gmail.com");
        loginRequest.setUserPassword("Asad19671999@");
        ...
        RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq)
                ...
                .formParam("productAddedBy", userId).param("productCategory", "fashion")
                .param("productSubCategory", "shirts").param("productPrice", "11500")
                .param("productDescription", "Lenova").param("productFor", "men")
                .multiPart("productImage", new File("C:\\Users\\AunAbbas\\Downloads\\Cypress Certificate.jpg"));
